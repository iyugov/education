...
from base.objects.enums.gender.models import Gender
...
class Individual(models.Model):
    ...
    def title_with_status(self):
        ...
        if hasattr(self, 'student'):
            student_enrollments = self.student.class_group_enrollment_registry
            last_class_group_enrollment_registry_item = student_enrollments.order_by('-enrollment_date').first()
