...
from ....generic_models import RegistryItem
from ....entities.catalogs.student.models import Student
from ....entities.catalogs.class_group.models import ClassGroup
from ....entities.documents.class_group_enrollment.models import ClassGroupEnrollment


class ClassGroupEnrollmentRegistryItem(RegistryItem):
