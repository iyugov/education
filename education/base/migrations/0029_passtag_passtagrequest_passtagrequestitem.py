...
import base.catalogs.models.pass_tag
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag_id', models.CharField(max_length=9, unique=True, validators=[base.catalogs.models.pass_tag.tag_id_validator], verbose_name='Идентификатор')),
            ],
            options={
                'verbose_name': 'Чип',
